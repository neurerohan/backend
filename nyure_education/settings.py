...
ROOT_URLCONF = 'nyure_education.urls'
...
WSGI_APPLICATION = 'nyure_education.wsgi.application'
...
DATABASES = {
    'default': dj_database_url.config(
        default=os.environ.get('DATABASE_URL', 'postgresql://postgres:postgres@localhost:5432/nyure_education'),
        conn_max_age=600,
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@nyureeducation.com')
